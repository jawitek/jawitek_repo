/* Kanno Noodle — site copy.
   Keys are referenced from the markup via data-i18n / data-i18n-placeholder /
   data-i18n-alt, and from main.js for the strings it renders itself. */
...
window.KANNO_I18N = {
  ...
  EN: {
    ...
    meta: {
      title: 'Kanno Noodle — The art of Japanese noodles, made in Europe',
      description: 'Japanese ramen noodles produced in central Poland by the Kanno family joint venture. Five styles, with or without egg, IFS Food certified, frozen with 12 months shelf life.',
      ogDescription: "Seventy years of Kanno family craft, Japanese recipes and know-how, produced in central Poland for ramen kitchens and retail across Europe."
    },
    ...
    products: {
      ...
      specPortion: 'Portion',
      specAllergens: 'Allergens',
      specShelf: 'Shelf life',
      shelfValue: '12 months at −18 °C',
      badgeAll: 'With or without egg',
      badgeEgg: 'With egg',
      badgeNoEgg: 'Egg-free',
      allergensAll: 'Gluten (egg optional)',
      allergensEgg: 'Gluten, egg',
    ...
    contact: {
      ...
      role1: 'Restaurant or chain',
      role2: 'Retail / grocery',
      role3: 'Distributor or importer',
      role4: 'Private label',
      role5: 'Other',
      message: 'Your message',
      messagePh: 'Styles, portion weight, monthly volume, delivery market',
      submit: 'Send inquiry',
      submitSending: 'Sending…',
      submitSent: 'Thank you — we will reply shortly',
      formSent: 'Your inquiry has reached us. We answer every message, usually within one working day.',
      formError: 'The inquiry could not be sent. Please try again, or write to us directly at hello@kanno.pl.',
      formNote: 'Your mail client should open with the inquiry ready to send. If it does not, write to hello@kanno.pl.',
      mailSubject: 'Noodle inquiry',
      mailName: 'Name',
      mailEmail: 'E-mail',
      mailRole: 'Contacting as'
    },

    footer: {
      copy: '© 2026 Kanno Noodle Sp. z o.o.',
      tag: 'The art of Asian noodles',
    ...
    alt: {
      logo: 'Kanno Noodle',
      ifs: 'IFS Food certified',
      flags: 'Japan and Poland',
      board: 'Fresh noodles on a wooden board',
      flour: 'Selected wheat flour',
      shop: 'Ramen shop at night',
      sapporo: 'Sapporo style noodles',
      temomi: 'Temomi style noodles',
      straight: 'Tokyo straight noodles',
  ...
  PL: {
    ...
    products: {
      ...
      specPortion: 'Porcja',
      specAllergens: 'Alergeny',
      specShelf: 'Termin przydatności',
      shelfValue: '12 miesięcy w temp. −18 °C',
      badgeAll: 'Z jajkiem lub bez',
      badgeEgg: 'Z jajkiem',
      badgeNoEgg: 'Bez jajka',
      allergensAll: 'Gluten (opcjonalnie jajko)',
      allergensEgg: 'Gluten, jajko',
      allergensNoEgg: 'Gluten',
    ...
    contact: {
      ...
      emailPh: 'twoj@emailfirmowy.pl',
      role: 'Kontaktuję się jako:',
      role1: 'Restauracja lub sieć lokali',
      role2: 'Handel detaliczny / supermarket',
      role3: 'Dystrybutor lub importer',
      role4: 'Marka własna (Private label)',
      role5: 'Inne',
      message: 'Twoja wiadomość',
      messagePh: 'Style, gramatura porcji, miesięczny wolumen, rynek docelowy',
      submit: 'Wyślij zapytanie',
      submitSending: 'Wysyłanie…',
      submitSent: 'Dziękujemy — odpowiemy najszybciej, jak to możliwe',
  ...
  JA: {
    htmlLang: 'ja',
    /* No Japanese version of the policy yet — the English page is served. */
    privacyHref: 'privacy.html',

    meta: {
      title: '菅野製麺所（Kanno Noodle）— 欧州で創る、日本の麺の真髄',
      description: 'ポーランド中部の菅野ファミリー合弁工場で製造される本格生ラーメン（冷凍）。選べる5つのスタイル、卵入り／卵不使用、IFS Food認証取得、賞味期限12ヶ月（冷凍）。',
      ogDescription: '菅野ファミリー70年の職人技と秘伝のレシピ。ポーランド中部の最新鋭工場から、欧州全域のラーメン店および小売店へ本物の麺をお届けします。'
    },
    ...
    products: {
      ...
      filterNoEgg: '卵不使用',
      specPortion: '1食あたり',
      specAllergens: 'アレルギー情報',
      specShelf: '賞味期限',
      shelfValue: '−18℃以下で12ヶ月',
      badgeAll: '卵入り / 卵不使用',
      badgeEgg: '卵入り',
      badgeNoEgg: '卵不使用',
      allergensAll: '小麦（卵は選択可）',
      allergensEgg: '小麦、卵',
      allergensNoEgg: '小麦',
    ...
    contact: {
      ...
      role2: '小売・スーパーマーケット',
      role3: '卸売・輸入商社',
      role4: 'プライベートブランド（PB・OEM）',
      role5: 'その他',
      message: 'お問い合わせ内容',
      messagePh: 'ご希望の麺のスタイル、食あたりの重量、月間想定数量、納品先国・地域など',
      submit: '問い合わせを送信',
      submitSending: '送信中…',
      submitSent: 'お問い合わせありがとうございます。担当者より近日中にご連絡いたします。',
      formSent: 'お問い合わせを受け付けました。通常1営業日以内にご返信いたします。',
      formError: '送信できませんでした。お手数ですが、もう一度お試しいただくか、hello@kanno.pl まで直接ご連絡ください。',
      formNote: 'メールソフトが自動で起動しない場合は、お手数ですが hello@kanno.pl まで直接ご連絡ください。',
      mailSubject: '麺に関するお問い合わせ',
      mailName: 'お名前',
      mailEmail: 'メールアドレス',
      mailRole: 'お問い合わせ区分'
    },
